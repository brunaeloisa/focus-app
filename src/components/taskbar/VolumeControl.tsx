export default function VolumeControl() {
  return (
    <div
      ...
      className="bg-base out-3d absolute right-0 bottom-full z-999 mb-2 flex w-20 flex-col items-center gap-2.5 p-2"
    >
      <span className="font-semibold select-none">Volume</span>

      <input
        type="range"
        min="0"
        max="100"
        className="custom-slider h-28 rotate-180 appearance-none"
